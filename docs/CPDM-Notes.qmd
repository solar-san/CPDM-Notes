...
Same stuff that can be done in **R** can be done in **Python**; in this course we are also using cloud environments: 

> **Anaconda Navigator**, also for *Jupyter notebooks*, which contain text and code in the same file.
Useful for narration of data science tasks.

> **Colab** (Google platform for Data Science),

> **Replit** (learning environment, not for development)

> **Hackerrank**: platform to run and test code.
...
### 3.Programming: This Is Your Life Now
...
[^4]: George Boole was the first mathematician to define and algebraic system of *logic* in the mid 19^th^ century
...
>**The moral is**: learn to actually *use* the goddamn program if you want an easy life!
